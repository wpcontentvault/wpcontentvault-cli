...
class ClassificationService
{
    ...
    public function suggestCategoryForArticle(Article $article, Collection $collection): Category
    {
        ...
        $result = $this->suggestCategory($title, $annotation, $collection);
    ...
    public function suggestCategory(string $title, string $annotation, Collection $categories): ClassificationResult
    {
        $system = <<<SYSTEM
...
User provides you article title and its annotation and you should choose most suitable category from list below.
