...
class LockArticleTranslationCommand extends AbstractApplicationCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lock-article-translation {id} {locale}';
     ...
     * @var string
     */
    protected $description = 'Locks article translation for locale';
    ...
    public function handle(
        ...
        touch($article->path . '/' . $locale->code . '.lock');
